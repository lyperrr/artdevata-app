...
const BlogDetail = () => {
  ...
  if (loading) return <AppLayout><div className="min-h-screen flex items-center justify-center"><Loader2 className="w-12 h-12 animate-spin text-primary" /></div></AppLayout>;
  if (!post) return <AppLayout><div className="container py-32 text-center"><h1 className="text-4xl font-bold mb-6">Artikel Tidak Ditemukan</h1><Button onClick={() => navigate("/blog")}>Kembali</Button></div></AppLayout>;
